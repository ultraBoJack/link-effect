...
<style lang="stylus">
  ...
  *::after{
  ...
  .e1 a:hover::before, .e1 a:hover::after{
    opacity: 1;
  ...
  .e12{
    ...
    a {
      ...
      &::before, &::after{
        ...
        width: 100px
        height: 100px
        border: 2px solid rgba(121,25,36,0.1)
        border-radius 50%
        background: transparent
        top: 50%
        left: 50%
      ...
      &::after{
        border:  6px solid rgba(12,125,36,0.2)
        width: 75px
        height: 75px
